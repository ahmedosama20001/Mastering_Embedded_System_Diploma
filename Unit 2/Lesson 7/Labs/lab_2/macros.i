...
void CAN_send()
{
 if (3 > 1) printf("@ Func :%s ,File : %s , Line : %d", __func__, ".\\macros.c",6); printf(">> \t");printf("\n" );;
}
void can_init()
{
 if (3 > 1) printf("@ Func :%s ,File : %s , Line : %d", __func__, ".\\macros.c",10); printf(">> \t");printf("\n" );;
}
int main()
{
 if (3 > 1) printf("@ Func :%s ,File : %s , Line : %d", __func__, ".\\macros.c",14); printf(">> \t");printf("\n" );;
 can_init();
 CAN_send();
 return 0;
}
